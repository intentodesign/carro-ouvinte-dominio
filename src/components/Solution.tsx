      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-primary-foreground leading-tight">
            ...
            <span className="text-primary">"caixa preta"</span>
          </h2>
          ...
          <div className="space-y-6 text-lg md:text-xl text-primary-foreground/90 leading-relaxed">
            ...
            <p className="text-2xl font-semibold text-primary-foreground">
              Você só precisa entender <span className="text-primary">os sinais certos</span> — <br />
              e saber fazer <span className="text-primary">as perguntas certas</span>.
            </p>
            <p className="pt-4">
              É exatamente isso que <span className="font-bold text-primary">Giovana Toso</span>, 
